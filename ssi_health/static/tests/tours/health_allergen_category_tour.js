odoo.define("ssi_health.health_allergen_category_tour", function (require) {
    "use strict";
    ...
    tour.register(
        "ssi_health_health_allergen_category_create",
        {
            test: true,
            url: "/web",
        },
        [
            // ── Flow 1 — Open the Health > Configuration > Allergen Categories menu
            ...
            {
                content: "Open the Allergen Categories menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_health.health_allergen_category_menu"]',
            },
            {
                // Guard: opening the Health app lands on the FIRST configuration
                // menu (Disease Categories), so the Allergen Categories action is
                // still loading right after the menu click. Wait for its
                // breadcrumb before touching anything, otherwise the next step
                // would act on the Disease Categories list still on screen.
                content: "Allergen Categories list is displayed",
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(Allergen Categories)",
            ...
            // ── Flow 3 — Fill in the required fields
            {
                ...
                run: "text TOUR-CREATE-ALLERGEN-CATEGORY",
            },
            {
            ...
            {
                content: "Allergen Category record is saved",
            ...
            // ── Flow 5 — Click the Allergen Categories breadcrumb to return
            // to the list
            {
                content: "Click the Allergen Categories breadcrumb",
                trigger:
                    ".breadcrumb-item.o_back_button a:contains(Allergen Categories)",
            },

            // ── Post-Condition — The new Allergen Category appears in the list
            {
                content: "New record is shown in the list",
                trigger:
                    ".o_list_view .o_data_row:contains(TOUR-CREATE-ALLERGEN-CATEGORY)",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            },
    ...
    tour.register(
        "ssi_health_health_allergen_category_edit",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // ── Flow 2 — Find and open the Allergen Category record to edit
            {
                content: "Open the allergen category record",
                trigger:
                    ".o_data_row:contains(TOUR-EDIT-ALLERGEN-CATEGORY) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
            ...
            // ── Flow 4 — Change the required fields (Name, Code)
            {
                ...
                trigger: ".o_field_widget[name='name']",
                run: "text TOUR-EDIT-ALLERGEN-CATEGORY UPDATED",
            },
    ...
    tour.register(
        "ssi_health_health_allergen_category_delete",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // ── Flow 2 — Open the Allergen Category record to delete
            {
                content: "Open the allergen category record",
                trigger:
                    ".o_data_row:contains(TOUR-DELETE-ALLERGEN-CATEGORY) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Form is open",
            ...
            // longer shows it
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR-DELETE-ALLERGEN-CATEGORY)))",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            },
    ...
    tour.register(
        "ssi_health_health_allergen_category_deactivate",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // ── Flow 2 — Open the Allergen Category record to deactivate
            {
                content: "Open the allergen category record",
                trigger:
                    ".o_data_row:contains(TOUR-DEACTIVATE-ALLERGEN-CATEGORY) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Form is open",
    ...
    tour.register(
        "ssi_health_health_allergen_category_activate",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // ── Flow 3 — Open the archived Allergen Category record to reactivate
            {
                content: "Open the archived allergen category record",
                trigger:
                    ".o_data_row:contains(TOUR-ACTIVATE-ALLERGEN-CATEGORY) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Form is open",
