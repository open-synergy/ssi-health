...
Stores the anthropometric measurement history (height, weight, and head
circumference) of a contact, with the latest value of each always
available as a stored field on the contact.
